...
// !!!!!
// Music boat additions:
import { type Queue } from '../../../utils/queue';
import { type InactiveStriker } from '../../../Structures/Song';
//
...
declare class Player<N extends Node = Node> extends TypedEmitter<PlayerEvents> {
    ...
    lastUpdate?: number;
    // !!!!!!!!!!!!
    // rest of music boat stuff
    /// i dont want to bother with typescript hell (i know this probably a bad way but please)
    // also if theres an easier way, do let me know so i dont have to edit a library file
    loop?: boolean;
    queueLoop?: boolean;
    queue?: Queue;
    skips?: Array<string>;
